...
import {InvisibleH2} from '../components/H2';
      ...
      <IntroPageSection id="intro" isIntro={true}>
		...
		c4.4,0,8.1-3.6,8.1-8.1V309.6L-31.8,309.6z" style={{'opacity': 0}}/>
              ...
              <g id="g2" style={{'opacity': 0}}>
                <text id="t2" fill="#FFF" fontSize="47" textAnchor="end" x="555" y="545">I’m Johan
                  Meester
                </text>
                <defs>
                  <mask id="m1">
                ...
                <image xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref={MyPicture} preserveAspectRatio="none" x="520" y="374" width="65" height="65" mask="url('#m1')"/>
              </g>
              <text id="t3" style={{'fontSize': '20px', 'textAnchor': 'end', 'opacity': 0}} fill="#FFF" x="555" y="580">FRONT-END DEVELOPER
              </text>
            </svg>
          </SpeechBubble>
        </IntroHeader>
