...
const messages = {
  'idle': <FormattedMessage id={'send_button.idle'} defaultMessage={'Send'}/>,
  'sending': <FormattedMessage id={'send_button.sending'} defaultMessage={'Sending...'}/>,
  'success': <FormattedMessage id={'send_button.success'}
